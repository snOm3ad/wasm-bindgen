...
export function wasm_bindgen__convert__closures__invoke1_mut__h5609ea2e82b2d466(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4a0e2e4a8c7d5bb5(a: number, b: number, c: number): void;
